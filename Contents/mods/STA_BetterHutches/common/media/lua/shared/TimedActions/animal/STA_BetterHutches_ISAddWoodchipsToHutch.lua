...
function STA_BetterHutches_ISAddWoodchipsToHutch:isValid()
    return (self.character:getInventory():containsTypeRecurse("STA_BetterHutches.WoodchipsBag") and (Utils.getObjectModData(self.hutch, "hasWoodChips") or 0) < Utils.getSandboxInt("WoodchipsBagAmount"))
end
